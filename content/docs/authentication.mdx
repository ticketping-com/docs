...
<Callout type="warn">
  Never expose this secret in your frontend code. It should only be stored on
  your backend.
</Callout>
...
| ------------------------- | -------- | ---------------------------------------------- |
| <Pill>external_id</Pill>  | ✅       | Unique user ID in your system                  |
| <Pill>email</Pill>        | ✅       | User’s email address                           |
| <Pill>display_name</Pill> | Optional | Friendly name to show in Ticketping            |
| <Pill>exp</Pill>          | ✅       | Expiration timestamp (short-lived recommended) |
...
On your frontend, call your new API and provide the token when initializing the widget via <Pill>userJWT</Pill> param:
